...
\hypersetup{
  pdftitle={Exploratory functional data analysis via PCA},
...
\pagestyle{fancy}
\lfoot{}\cfoot{}\rfoot{}
\lhead{\textsf{Exploratory functional data analysis via PCA}}
\rhead{\textsf{\thepage}}
...
\title{Exploratory functional data analysis via PCA}
